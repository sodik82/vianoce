      ...
      <div className="canvas">
        <div className="Stromcek">
          <svg xmlns="http://www.w3.org/2000/svg" >
            ...
            <rect x={penX} y={penY} width="40" height="100" style={{fill:'brown'}}/>
          </svg>
        </div>
        {poschodia.map((p,i) => <GulovePoschodie {...p} key={i} />)}
        {this.state.stars}
        {this.state.podpis &&
          <svg style={{position: 'absolute', top: '250px', left: '110px', width: '300px', height: '150px', zIndex:10}} xmlns="http://www.w3.org/2000/svg" version="1.1">
            <defs>
